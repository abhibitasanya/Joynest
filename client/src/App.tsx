...
function Navbar({ onAuth, onDash, view }: { onAuth: () => void; onDash: () => void; view: View }) {
  ...
  return (
    <nav
      ...
      style={{
        background: scrolled ? 'rgba(248,246,248,0.92)' : 'transparent',
        backdropFilter: scrolled ? 'blur(20px)' : 'none',
        borderBottom: scrolled ? '1px solid rgba(220,208,255,0.15)' : 'none',
...
function HeroSection({ onStart, view }: { onStart: () => void; view: View }) {
  const particles = Array.from({ length: 18 }, (_, i) => ({
    ...
    background: ['rgba(220,208,255,0.5)', 'rgba(184,165,224,0.4)', 'rgba(216,208,232,0.5)', 'rgba(197,184,212,0.5)'][Math.floor(Math.random() * 4)],
  ...
  return (
    ...
    >
      ...
      {/* Floating polaroids - only on landing page */}
      {view === 'landing' && polaroidData.map((p, i) => <FloatingPolaroid key={i} data={p} />)}

      {/* Hero content */}
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        <div className="animate-fadeInUp delay-100 inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8"
          style={{ background: 'rgba(220,208,255,0.12)', border: '1px solid rgba(220,208,255,0.3)' }}>
...
function FeaturesSection({ onFeatureSelect }: { onFeatureSelect: (feature: typeof features[0]) => void }) {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f, i) => (
            <div
              ...
              style={{
                background: f.color,
                border: '1px solid rgba(154,127,208,0.06)',
    ...
    <section id="templates" className="py-32 px-6" style={{ background: 'linear-gradient(180deg, #F8F6F8 0%, #F4F0FF 100%)' }}>
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          ...
          <button 
            onClick={() => {
              // In a real app, this would navigate to a full templates gallery
              alert('Full templates gallery coming soon! For now, try the featured templates below by clicking "Use This Template" on any template.');
            }}
            className="self-start md:self-auto text-sm font-medium px-6 py-3 rounded-full transition-all duration-200"
            style={{ border: '1px solid rgba(154,127,208,0.2)', color: '#9A7FD0' }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {templates.map((t, i) => (
            <div
              ...
              style={{ 
                boxShadow: hovered === i ? '0 24px 60px rgba(154,127,208,0.14)' : '0 4px 20px rgba(154,127,208,0.06)',
            ...
            >
              <div className="relative overflow-hidden" style={{ height: 200 }}>
                ...
                <div className="absolute inset-0 transition-opacity duration-300"
                  style={{ background: 'linear-gradient(180deg, transparent 40%, rgba(154,127,208,0.6) 100%)',
                    ...
                    onClick={() => {
                      ...
                      if (previewWindow) {
                        previewWindow.document.write(`
                          <html>
                            <head><title>Template Preview: ${t.name}</title></head>
                            <body style="margin:0;display:flex;align-items:center;justify-content:center;height:100vh;background:#F4F0FF;font-family:Arial,sans-serif;">
                              <div style="text-align:center;">
                                <h1 style="color:#9A7FD0;">${t.name}</h1>
                                <p style="color:#A0A0A0;">Template Preview</p>
                                <img src="${t.img}" style="max-width:80%;max-height:80vh;border-radius:12px;box-shadow:0 20px 60px rgba(154,127,208,0.2);">
                                <p style="margin-top:20px;color:#DCD0FF;">Rating: ${t.rating}★</p>
                              </div>
                            </body>
                          </html>
                        `);
...
const testimonials = [
  { 
    name: 'Amara Osei', 
    role: 'Made a birthday site for her mother', 
    quote: "She cried. I cried. Everyone cried. JoyNest turned a few photos and words into something I'll treasure forever. The interactive timeline feature let me arrange 60 years of memories chronologically, and the voice notes from family members made it incredibly personal. My mom still visits the site every Sunday.", 
    avatar: 'https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=80&h=80&fit=crop&auto=format', 
    rating: 5 
  },
  { 
    name: 'Luca Ferretti', 
    role: 'Wedding anniversary gift', 
    quote: "My wife said it was the most romantic thing I'd ever done. The page-flip journals and voice notes made it feel like magic. I used the Love Letters template and customized it with our wedding photos, the background music feature let me add our first dance song, and the password protection made it intimate for just the two of us.", 
    avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=80&h=80&fit=crop&auto=format', 
    rating: 5 
  },
  { 
    name: 'Yuna Tanaka', 
    role: 'Graduation surprise for friends', 
    quote: "We built a surprise site for our whole friend group. The gallery and music made it feel like a film. So much love in one place. The masonry gallery layout was perfect for our 500+ photos from college, and the share feature made it easy for everyone to contribute their own memories and photos.", 
          ...
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <blockquote className="text-base leading-relaxed mb-6 italic"
                style={{ color: 'rgba(248,246,248,0.85)', fontFamily: 'var(--font-serif)', fontWeight: 400 }}>
                "{t.quote}"
              </blockquote>
              <div className="flex items-center gap-3">
                <div className="relative">
                  <img src={t.avatar} alt={t.name} className="w-12 h-12 rounded-full object-cover animate-rotateFloat" style={{ border: '2px solid rgba(220,208,255,0.4)', animationDelay: `${i * 0.2}s` }} />
                ...
                <div>
                  ...
                  <div className="text-xs" style={{ color: 'rgba(248,246,248,0.5)' }}>{t.role}</div>
                </div>
              </div>
            </div>
          ))}
  ...
  return (
    <section className="py-32 px-6 relative overflow-hidden" style={{ background: 'linear-gradient(165deg, #F8F6F8 0%, #F4F0FF 50%, #F8F6F8 100%)' }}>
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-8 animate-fadeInUp" style={{ background: 'rgba(220,208,255,0.12)', border: '1px solid rgba(220,208,255,0.3)' }}>
        ...
        <div className="animate-fadeInUp delay-300 flex flex-col sm:flex-row gap-4 justify-center mt-10">
          ...
          <button className="flex items-center gap-2 px-8 py-4 rounded-full font-medium text-base transition-all duration-200 hover:bg-[#F4F0FF] card-hover"
            style={{ color: '#9A7FD0', border: '1px solid rgba(154,127,208,0.15)' }}>
...
function Footer() {
  return (
    <footer className="py-16 px-6" style={{ background: '#9A7FD0', borderTop: '1px solid rgba(220,208,255,0.1)' }}>
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2">
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ background: 'rgba(220,208,255,0.2)' }}>
                <span>🪺</span>
              </div>
              <span className="font-serif text-xl font-semibold text-white">JoyNest</span>
            </div>
            <p className="text-sm leading-relaxed max-w-xs" style={{ color: 'rgba(248,246,248,0.5)' }}>
                ...
                {col.links.map(link => (
                  <li key={link}>
                    <a href="#" className="text-sm transition-colors duration-200 hover:text-[#DCD0FF]"
                      style={{ color: 'rgba(248,246,248,0.5)' }}>{link}</a>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8"
          ...
          <p className="text-sm" style={{ color: 'rgba(248,246,248,0.35)' }}>© 2026 JoyNest. Made with love and a little magic.</p>
          <div className="flex gap-4 mt-4 md:mt-0">
            {['Twitter', 'Instagram', 'Pinterest'].map(s => (
              <a key={s} href="#" className="text-sm transition-colors duration-200 hover:text-[#DCD0FF]"
                style={{ color: 'rgba(248,246,248,0.4)' }}>{s}</a>
            ))}
          </div>
        </div>
      </div>
...
function AuthModal({ onClose, onSuccess }: { onClose: () => void; onSuccess: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4"
      style={{ background: 'rgba(154,127,208,0.6)', backdropFilter: 'blur(12px)' }}
      onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="w-full max-w-4xl rounded-3xl overflow-hidden animate-scaleIn"
        style={{ boxShadow: '0 40px 100px rgba(154,127,208,0.3)', border: '1px solid rgba(220,208,255,0.2)' }}>
        <div className="grid md:grid-cols-2">
          ...
          <div className="relative hidden md:flex flex-col items-center justify-center p-12 overflow-hidden"
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-sm leading-relaxed" style={{ color: 'rgba(248,246,248,0.6)' }}>
                Join thousands of people preserving their most precious moments in ways that feel magical.
              </p>
              <p className="mt-6 text-xs italic" style={{ color: 'rgba(220,208,255,0.8)', fontFamily: 'var(--font-serif)' }}>
          ...
          <div className="p-10 md:p-12 paper-texture" style={{ background: '#F8F6F8' }}>
            ...
            <button className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl mb-6 font-medium text-sm transition-all duration-200 hover:shadow-md"
              style={{ border: '1px solid rgba(154,127,208,0.15)', color: '#2A2A2A', background: 'white' }}>
            ...
            <div className="flex items-center gap-3 mb-6">
              <div className="flex-1 h-px" style={{ background: 'rgba(154,127,208,0.1)' }} />
...
function Dashboard({ onBack, onEditor, showProfileMenu, setShowProfileMenu, handleLogout }: { 
  onBack: () => void; 
  onEditor: () => void;
  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#F8F6F8' }}>
      ...
      <aside className="w-64 hidden lg:flex flex-col fixed top-0 left-0 h-screen z-40"
        style={{ background: '#9A7FD0', borderRight: '1px solid rgba(220,208,255,0.1)' }}>
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          {[
            ...
            { icon: '📁', label: 'My Projects', active: false, action: () => alert('My Projects view coming soon!') },
            { icon: '🎨', label: 'Templates', active: false, action: () => alert('Templates gallery coming soon!') },
            { icon: '📊', label: 'Analytics', active: false, action: () => alert('Analytics dashboard coming soon!') },
            { icon: '👤', label: 'Profile', active: false, action: () => alert('Profile settings coming soon!') },
            { icon: '⚙️', label: 'Settings', active: false, action: () => alert('Settings panel coming soon!') },
          ].map(item => (
            <button
              key={item.label}
              onClick={item.action}
              ...
              style={{
                background: item.active ? 'rgba(220,208,255,0.15)' : 'transparent',
                color: item.active ? '#DCD0FF' : 'rgba(248,246,248,0.6)',
              }}
              onMouseEnter={e => !item.active && (e.currentTarget.style.background = 'rgba(255,255,255,0.05)', e.currentTarget.style.color = 'rgba(248,246,248,0.9)')}
              onMouseLeave={e => !item.active && (e.currentTarget.style.background = 'transparent', e.currentTarget.style.color = 'rgba(248,246,248,0.6)')}
            >
              <span>{item.icon}</span>
              {item.label}
            </button>
        ...
        <div className="p-4 border-t" style={{ borderColor: 'rgba(255,255,255,0.08)' }}>
          <div className="rounded-xl p-4" style={{ background: 'rgba(220,208,255,0.1)', border: '1px solid rgba(220,208,255,0.2)' }}>
            <p className="text-xs font-medium mb-1" style={{ color: '#DCD0FF' }}>Free Plan</p>
            <p className="text-xs mb-3" style={{ color: 'rgba(248,246,248,0.5)' }}>2 of 3 projects used</p>
          ...
          <div className="flex items-center gap-3 mt-4 px-1 cursor-pointer group" onClick={() => setShowProfileMenu(!showProfileMenu)}>
            <img src="https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=80&h=80&fit=crop&auto=format" alt="Profile" className="w-8 h-8 rounded-full object-cover" style={{ border: '2px solid rgba(220,208,255,0.3)' }} />
            <div className="flex-1">
              <div className="text-sm font-medium" style={{ color: '#F8F6F8' }}>Alex Rivera</div>
              <div className="text-xs" style={{ color: 'rgba(248,246,248,0.4)' }}>alex@gmail.com</div>
            </div>
            <span className="text-xs" style={{ color: 'rgba(248,246,248,0.4)' }}>▼</span>
            
            {/* Profile dropdown menu */}
            {showProfileMenu && (
              <div className="absolute bottom-full left-0 mb-2 w-48 rounded-xl overflow-hidden shadow-lg z-50" style={{ background: 'white', border: '1px solid rgba(154,127,208,0.1)' }}>
                <button onClick={() => { setShowProfileMenu(false); alert('Profile settings coming soon!') }} className="w-full text-left px-4 py-3 text-sm hover:bg-[#F4F0FF] transition-colors" style={{ color: '#4A4A4A' }}>
                  👤 Profile Settings
                </button>
                <button onClick={() => { setShowProfileMenu(false); alert('Account settings coming soon!') }} className="w-full text-left px-4 py-3 text-sm hover:bg-[#F4F0FF] transition-colors" style={{ color: '#4A4A4A' }}>
                  ⚙️ Account
                </button>
                <button onClick={() => { setShowProfileMenu(false); alert('Billing information coming soon!') }} className="w-full text-left px-4 py-3 text-sm hover:bg-[#F4F0FF] transition-colors" style={{ color: '#4A4A4A' }}>
                  💳 Billing
                </button>
                <div className="h-px" style={{ background: 'rgba(154,127,208,0.1)' }} />
                <button onClick={() => { setShowProfileMenu(false); handleLogout() }} className="w-full text-left px-4 py-3 text-sm hover:bg-[#F4F0FF] transition-colors" style={{ color: '#9A7FD0' }}>
                  🚪 Logout
                </button>
              </div>
            )}
      ...
      <main className="flex-1 lg:ml-64 min-h-screen">
        ...
        <header className="sticky top-0 z-30 flex items-center justify-between px-6 lg:px-10 py-4"
          style={{ background: 'rgba(248,246,248,0.92)', backdropFilter: 'blur(20px)', borderBottom: '1px solid rgba(154,127,208,0.06)' }}>
          <div>
          ...
          <div className="flex items-center gap-3">
            <div className="relative hidden md:block">
              ...
              <input
                ...
                style={{ background: '#F4F0FF', border: '1px solid rgba(154,127,208,0.08)', color: '#2A2A2A', width: 200 }}
              />
            </div>
            <button
        ...
        <div className="px-6 lg:px-10 py-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
            {[
              ...
              <div key={s.label} className="rounded-2xl p-5 card-hover" style={{ background: s.color, border: '1px solid rgba(154,127,208,0.05)' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-6">
            {projects
              ...
              <div
                ...
                style={{
                  background: '#F8F6F8',
                  border: '1px solid rgba(154,127,208,0.07)',
                  boxShadow: hoveredCard === p.id ? '0 20px 50px rgba(154,127,208,0.1)' : '0 2px 12px rgba(154,127,208,0.04)',
                ...
                <div className="relative overflow-hidden" style={{ height: 180 }}>
                  ...
                  <div className="absolute top-3 left-3">
                    <span className="text-xs px-2.5 py-1 rounded-full font-medium capitalize"
                      style={{
                        background: p.status === 'published' ? 'rgba(154,127,208,0.85)' : 'rgba(220,208,255,0.85)',
                  ...
                  <div className="absolute top-3 right-3 flex gap-2 transition-all duration-300"
                    ...
                    <button
                      ...
                      style={{ background: 'rgba(248,246,248,0.95)', color: '#9A7FD0' }}>
                      Edit
                    </button>
                    <button 
                      onClick={() => {
                      ...
                      className="text-xs font-medium px-3 py-1.5 rounded-full transition-all duration-200"
                      style={{ background: 'rgba(220,208,255,0.9)', color: '#9A7FD0' }}>
                      Share
                    </button>
                  </div>
                </div>
            ...
            <button
              ...
              style={{
                border: '2px dashed rgba(154,127,208,0.15)',
                background: 'transparent',
                minHeight: 280,
                color: '#A0A0A0',
              }}
              onMouseEnter={e => { e.currentTarget.style.borderColor = '#DCD0FF'; e.currentTarget.style.background = 'rgba(220,208,255,0.04)' }}
              onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(154,127,208,0.15)'; e.currentTarget.style.background = 'transparent' }}
            >
...
function NewProjectModal({ onClose, onCreate }: { onClose: () => void; onCreate: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4"
      style={{ background: 'rgba(154,127,208,0.5)', backdropFilter: 'blur(12px)' }}
      onClick={e => e.target === e.currentTarget && onClose()}>
      <div className="w-full max-w-2xl rounded-3xl overflow-hidden animate-scaleIn"
        style={{ background: '#F8F6F8', boxShadow: '0 40px 100px rgba(154,127,208,0.25)', border: '1px solid rgba(220,208,255,0.15)' }}>
        <div className="p-8">
          {/* Step indicator */}
            ...
            <div className="flex items-center gap-2">
              {steps.map((s, i) => (
                <div key={s} className="flex items-center gap-2">
                  ...
                  {i < steps.length - 1 && (
                    <div className="w-8 h-px mb-4" style={{ background: i + 1 < step ? '#DCD0FF' : 'rgba(154,127,208,0.1)' }} />
                  )}
                </div>
              ))}
            </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {templateOptions.map((t, i) => (
                  <button
                    ...
                    style={{
                      border: selected === i ? '2px solid #DCD0FF' : '2px solid rgba(154,127,208,0.08)',
                      transform: selected === i ? 'scale(1.02)' : 'scale(1)',
                      boxShadow: selected === i ? '0 8px 24px rgba(220,208,255,0.2)' : 'none',
                    }}
                  >
              ...
              {[
                ...
                <div key={f.label}>
                  ...
                  <input
                    ...
                    style={{ background: 'white', border: '1.5px solid rgba(154,127,208,0.12)', color: '#2A2A2A' }}
                    onFocus={e => e.target.style.borderColor = '#DCD0FF'}
                    onBlur={e => e.target.style.borderColor = 'rgba(154,127,208,0.12)'}
                  />
                </div>
              ))}
            </div>
          ...
          <div className="flex gap-3 mt-8">
            {step > 1 && (
              <button
                ...
                style={{ border: '1px solid rgba(154,127,208,0.15)', color: '#2A2A2A' }}
  ...
  return (
    <div className="flex flex-col h-screen" style={{ background: '#9A7FD0' }}>
      ...
      <header className="flex items-center justify-between px-4 py-3 shrink-0"
        style={{ background: '#7A5FB0', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        <div className="flex items-center gap-3">
          <button onClick={onBack} className="p-2 rounded-lg transition-colors text-sm" style={{ color: 'rgba(248,246,248,0.6)' }}
          ...
          <span className="text-xs px-2 py-0.5 rounded-full" style={{ background: 'rgba(220,208,255,0.2)', color: '#DCD0FF' }}>Draft</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          {[['↩', 'Undo'], ['↪', 'Redo']].map(([icon, label]) => (
            <button key={label} title={label} className="w-8 h-8 flex items-center justify-center rounded-lg text-sm transition-colors"
              style={{ color: 'rgba(248,246,248,0.6)' }}
              onMouseEnter={e => e.currentTarget.style.background = 'rgba(255,255,255,0.08)'}
              onMouseLeave={e => e.currentTarget.style.background = 'transparent'}>
              {icon}
            </button>
          ...
          <button className="px-4 py-1.5 rounded-lg text-xs font-medium transition-all duration-200"
            style={{ color: 'rgba(248,246,248,0.7)', border: '1px solid rgba(255,255,255,0.15)' }}
            onMouseEnter={e => e.currentTarget.style.background = 'rgba(255,255,255,0.08)'}
            onMouseLeave={e => e.currentTarget.style.background = 'transparent'}>
            Preview
          </button>
          <button className="px-4 py-1.5 rounded-lg text-xs font-medium transition-all duration-200"
            style={{ background: 'rgba(220,208,255,0.15)', color: '#DCD0FF', border: '1px solid rgba(220,208,255,0.25)' }}>
            Save
          </button>
          <button
            onClick={onPublish}
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Left sidebar */}
        <aside className="w-56 shrink-0 flex flex-col" style={{ background: '#7A5FB0', borderRight: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="p-3 space-y-0.5 flex-1 overflow-y-auto">
            <p className="text-xs font-medium px-3 py-2 uppercase tracking-wider" style={{ color: 'rgba(248,246,248,0.3)' }}>Sections</p>
            {sections.map(s => (
              <button
                key={s.id}
                ...
                style={{
                  background: activeSection === s.id ? 'rgba(220,208,255,0.15)' : 'transparent',
                  color: activeSection === s.id ? '#DCD0FF' : 'rgba(248,246,248,0.6)',
                }}
                onMouseEnter={e => activeSection !== s.id && (e.currentTarget.style.background = 'rgba(255,255,255,0.05)', e.currentTarget.style.color = 'rgba(248,246,248,0.9)')}
                onMouseLeave={e => activeSection !== s.id && (e.currentTarget.style.background = 'transparent', e.currentTarget.style.color = 'rgba(248,246,248,0.6)')}
              >
                <span>{s.icon}</span>
                {s.label}
              </button>
        ...
        {/* Center preview */}
        <main className="flex-1 overflow-y-auto p-6 flex items-start justify-center" style={{ background: '#7A5FB0' }}>
          <div className="w-full max-w-2xl rounded-2xl overflow-hidden"
            ...
            <div className="relative overflow-hidden" style={{ height: 200, background: 'linear-gradient(135deg, #9A7FD0, #B8A5E0)' }}>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-sm font-light" style={{ color: 'rgba(248,246,248,0.8)' }}>For the most wonderful Mum in the world</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6">
              {activeSection === 'gallery' && (
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-serif text-xl font-semibold" style={{ color: '#9A7FD0' }}>Memories Gallery</h3>
                    <label className="btn-gold text-xs px-3 py-1.5 rounded-full cursor-pointer">
                      📷 Add Photos
                      <input type="file" accept="image/*" multiple className="hidden" onChange={(e) => {
                        const files = e.target.files;
                        if (files && files.length > 0) {
                          alert(`Added ${files.length} photo(s)! In a real app, these would be uploaded to your project.`);
                        }
                      }} />
                    </label>
                  </div>
                  <div className="columns-3 gap-3">
                    {galleryImages.map((img, i) => (
                      <div key={i} className="mb-3 rounded-xl overflow-hidden group cursor-pointer card-hover" onClick={() => {
                  ...
                  <div className="mt-4 border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition-colors duration-200"
                    style={{ borderColor: 'rgba(154,127,208,0.15)', color: '#A0A0A0' }}
                    onMouseEnter={e => { e.currentTarget.style.borderColor = '#DCD0FF'; e.currentTarget.style.background = 'rgba(220,208,255,0.04)' }}
                    onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(154,127,208,0.15)'; e.currentTarget.style.background = 'transparent' }}
              ...
              {activeSection === 'journal' && (
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="font-serif text-xl font-semibold" style={{ color: '#9A7FD0' }}>Journal Pages</h3>
                    <button className="btn-gold text-xs px-3 py-1.5 rounded-full" onClick={() => alert('Add new journal page functionality coming soon!')}>
                      + Add Page
                    </button>
                  </div>
                  <div className="relative" style={{ minHeight: 300 }}>
                    <div className="rounded-xl p-6 paper-texture"
                      style={{ background: '#FFFEF8', border: '1px solid rgba(154,127,208,0.08)', boxShadow: '2px 4px 20px rgba(0,0,0,0.06)', lineHeight: '2rem',
                        backgroundImage: 'repeating-linear-gradient(transparent, transparent 31px, rgba(154,127,208,0.06) 31px, rgba(154,127,208,0.06) 32px)' }}>
                      <div className="absolute top-4 right-4">
                    ...
                    <div className="flex gap-3 mt-4">
                      <button className="btn-gold text-xs font-medium px-4 py-2 rounded-lg" onClick={() => alert('Previous page functionality coming soon!')}><span>← Previous</span></button>
                      <span className="text-xs px-3" style={{ color: '#A0A0A0' }}>1 / 3</span>
                      <button className="btn-gold text-xs font-medium px-4 py-2 rounded-lg" onClick={() => alert('Next page functionality coming soon!')}><span>Next →</span></button>
                    ...
                    <div className="p-8 paper-texture" style={{ background: '#FFFEF8' }}>
                      ...
                      <div className="mt-6 flex justify-end">
                        <div className="animate-wax-seal w-12 h-12 rounded-full flex items-center justify-center text-xl"
                          style={{ background: 'linear-gradient(135deg, #B8A5E0, #9A7FD0)', boxShadow: '0 4px 12px rgba(184,165,224,0.4)' }}>
                          ♥
                        </div>
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-6 p-6 rounded-2xl mb-6"
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs mb-3" style={{ color: 'rgba(248,246,248,0.5)' }}>Édith Piaf · 3:04</p>
                      ...
                      <div className="flex items-center justify-between text-xs" style={{ color: 'rgba(248,246,248,0.4)' }}>
        ...
        {/* Right sidebar */}
        <aside className="w-52 shrink-0 flex flex-col overflow-y-auto" style={{ background: '#7A5FB0', borderLeft: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="p-4 space-y-4">
            <p className="text-xs font-medium uppercase tracking-wider" style={{ color: 'rgba(248,246,248,0.3)' }}>Properties</p>
            ...
            {[
              ...
              <div key={prop.label}>
                <label className="block text-xs mb-1.5" style={{ color: 'rgba(248,246,248,0.5)' }}>{prop.label}</label>
                <div className="flex items-center gap-2">
                  <div className="w-7 h-7 rounded-lg border" style={{ background: prop.val, borderColor: 'rgba(255,255,255,0.15)' }} />
                  <span className="text-xs font-mono" style={{ color: 'rgba(248,246,248,0.6)' }}>{prop.val}</span>
                </div>
              </div>
            ))}

            <div>
              <label className="block text-xs mb-1.5" style={{ color: 'rgba(248,246,248,0.5)' }}>Font</label>
              <div className="px-3 py-2 rounded-lg text-xs"
                style={{ background: 'rgba(255,255,255,0.06)', color: 'rgba(248,246,248,0.7)', border: '1px solid rgba(255,255,255,0.08)' }}>
                Playfair Display
              </div>
            </div>

            <div>
              <label className="block text-xs mb-1.5" style={{ color: 'rgba(248,246,248,0.5)' }}>Animation</label>
              <div className="grid grid-cols-2 gap-1.5">
                {['Fade', 'Float', 'Slide', 'Flip'].map(a => (
                  <button key={a} className="text-xs py-1.5 rounded-lg transition-colors"
                    style={{ background: a === 'Fade' ? 'rgba(220,208,255,0.2)' : 'rgba(255,255,255,0.05)',
                      color: a === 'Fade' ? '#DCD0FF' : 'rgba(248,246,248,0.5)',
                      border: `1px solid ${a === 'Fade' ? 'rgba(220,208,255,0.3)' : 'rgba(255,255,255,0.08)'}` }}>
                    {a}
                  </button>
                ))}
              </div>
            ...
            <div>
              <label className="block text-xs mb-2" style={{ color: 'rgba(248,246,248,0.5)' }}>Visibility</label>
              {['Public', 'Private', 'Invite only'].map(v => (
                <label key={v} className="flex items-center gap-2 py-1.5 cursor-pointer">
                  ...
                  <span className="text-xs" style={{ color: v === 'Public' ? 'rgba(248,246,248,0.9)' : 'rgba(248,246,248,0.45)' }}>{v}</span>
                </label>
              ))}
            </div>
          </div>
    ...
    <div className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden"
      ...
      <div className="relative z-10 w-full max-w-lg text-center animate-scaleIn">
        ...
        <div className="flex items-center gap-2 p-2 rounded-2xl mb-4"
          style={{ background: 'white', border: '1.5px solid rgba(220,208,255,0.3)', boxShadow: '0 8px 30px rgba(154,127,208,0.08)' }}>
        ...
        <div className="flex justify-center mb-8">
          <div className="p-4 rounded-2xl bg-white" style={{ boxShadow: '0 4px 20px rgba(154,127,208,0.08)' }}>
        ...
        <div className="flex gap-3 justify-center mb-8">
          {[
            { icon: '📱', name: 'WhatsApp', url: 'https://wa.me/?text=Check out my memory project!' },
            { icon: '📘', name: 'Facebook', url: 'https://www.facebook.com/sharer/sharer.php?u=' },
            { icon: '🐦', name: 'Twitter', url: 'https://twitter.com/intent/tweet?text=Check out my memory project!' },
            { icon: '📧', name: 'Email', url: 'mailto:?subject=Check out my memory project&body=' }
          ].map(s => (
            <button 
              key={s.name} 
              onClick={() => {
                // Copy link to clipboard and open share service
                const shareUrl = 'https://joynest.app/project/mums-60th-birthday';
                navigator.clipboard.writeText(shareUrl).then(() => {
                  alert('Link copied to clipboard! Opening ' + s.name + '...');
                  window.open(s.url + encodeURIComponent(shareUrl), '_blank');
                }).catch(() => {
                  alert('Failed to copy link. Opening ' + s.name + '...');
                  window.open(s.url, '_blank');
                });
              }}
              className="text-xs font-medium px-4 py-2.5 rounded-xl transition-all duration-200"
              style={{ background: 'white', border: '1px solid rgba(154,127,208,0.1)', color: '#2A2A2A' }}
              onMouseEnter={e => { e.currentTarget.style.background = '#F4F0FF'; e.currentTarget.style.borderColor = 'rgba(220,208,255,0.3)' }}
              onMouseLeave={e => { e.currentTarget.style.background = 'white'; e.currentTarget.style.borderColor = 'rgba(154,127,208,0.1)' }}>
              {s.icon} {s.name}
            </button>
          ))}
        </div>
        ...
        <div className="flex gap-3 justify-center">
          <button
            onClick={onBack}
            className="px-6 py-3 rounded-xl text-sm font-medium transition-all duration-200"
            style={{ border: '1px solid rgba(154,127,208,0.15)', color: '#9A7FD0' }}
            onMouseEnter={e => e.currentTarget.style.background = '#F4F0FF'}
            onMouseLeave={e => e.currentTarget.style.background = 'transparent'}
          >
            Back to Dashboard
          ...
          <button 
            onClick={() => {
              ...
              const projectData = {
                ...
                template: "Birthday Delight",
                created: new Date().toISOString(),
                content: "Memory project data would be here"
              };
              const blob = new Blob([JSON.stringify(projectData, null, 2)], { type: 'application/json' });
              const url = URL.createObjectURL(blob);
              const a = document.createElement('a');
              a.href = url;
              a.download = 'memory-project.json';
...
function LandingPage({ onStart, onAuth, onFeatureSelect, selectedFeature, setSelectedFeature }: { 
  ...
  return (
    <div style={{ background: '#F8F6F8' }}>
      ...
      {selectedFeature && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: 'rgba(154,127,208,0.5)', backdropFilter: 'blur(8px)' }}>
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[80vh] overflow-y-auto p-8 relative animate-scaleIn">
            <button 
              onClick={() => setSelectedFeature(null)}
              className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center rounded-full hover:bg-[#F4F0FF] transition-colors"
              style={{ color: '#A0A0A0' }}
            >
              ×
            </button>
            ...
            <h2 className="font-serif text-3xl font-semibold mb-3" style={{ color: '#9A7FD0' }}>{selectedFeature.title}</h2>
            <p className="text-base leading-relaxed mb-6" style={{ color: '#4A4A4A' }}>{selectedFeature.desc}</p>
            
            <div className="space-y-4 text-sm" style={{ color: '#A0A0A0' }}>
              <div className="p-4 rounded-xl" style={{ background: '#F4F0FF' }}>
                <h4 className="font-semibold mb-2" style={{ color: '#9A7FD0' }}>How it works</h4>
                <p>Our {selectedFeature.title.toLowerCase()} feature uses advanced web technologies to create seamless, beautiful experiences. Simply drag and drop your content, and we handle the rest.</p>
              </div>
              
              <div className="p-4 rounded-xl" style={{ background: '#F2EEF8' }}>
                <h4 className="font-semibold mb-2" style={{ color: '#9A7FD0' }}>Perfect for</h4>
                <ul className="list-disc list-inside space-y-1">
                  <li>Birthday celebrations and milestones</li>
                  <li>Wedding anniversaries and special events</li>
                  <li>Family reunions and gatherings</li>
                  <li>Travel memories and adventures</li>
                </ul>
              </div>
              
              <div className="p-4 rounded-xl" style={{ background: '#E8E2FF' }}>
                <h4 className="font-semibold mb-2" style={{ color: '#9A7FD0' }}>Why users love it</h4>
                <p>"The {selectedFeature.title.toLowerCase()} feature made creating my mom's birthday site so easy and beautiful!" - Sarah M.</p>
              </div>
            </div>
            
            <button 
              onClick={() => { setSelectedFeature(null); onAuth(); }}
              className="btn-forest w-full mt-6 px-6 py-3 rounded-xl text-sm font-semibold"
            >
              Start Creating with {selectedFeature.title}
            </button>
          </div>
        </div>
      )}
